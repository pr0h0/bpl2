...
public class DoUntilStatementExpr : Expression
{
    public Expression Condition;
    public Expression Body;
    public Expression? Failsafe;

    public DoUntilStatementExpr(Expression condition, Expression body, Expression? failsafe = null) : base(ExprType.DoUntilStatementExpr)
    {
        Condition = condition;
        Body = body;
        Failsafe = failsafe;
